...
3. Open FireVault while online once so the service worker can cache Build 0.94.0.
4. When the update banner appears, choose **Update Now**.
5. Confirm Settings section spacing, Account Directory search formatting, bottom navigation, and iPhone/iPad layouts.
