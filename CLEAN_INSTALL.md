# Clean Install Notes — FireVault Build 0.50.63

This ZIP is intended to be used as the new clean baseline for FireVault Build 0.50.63.
...
Build 0.50.63 continues from the stable 0.50.62 baseline and adds a Field Focus module toggle.
...
- Adds Field Focus to Settings → Modules so the Home dashboard can be disabled.
- Keeps Action Center available even when the Home Field Focus card is disabled.
