# Clean Install Notes — FireVault Build 0.50.69

This ZIP is intended to be used as the new clean baseline for FireVault Build 0.50.69.
...
Build 0.50.69 continues from the stable 0.50.68 baseline and adds Daily Summary date selection plus Home top-placement cleanup.
...
- Tightens the Home screen initial top placement.
- Tap Today/date on Home to open a date picker and pull up past Daily Summary reports.
