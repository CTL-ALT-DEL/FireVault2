# Clean Install Notes — FireVault Build 0.50.71

This ZIP is intended to be used as the new clean baseline for FireVault Build 0.50.71.
...
Build 0.50.71 continues from the stable 0.50.70 baseline and fixes the Home Daily Summary date picker.
...
- Replaces the unreliable hidden native date picker with a FireVault calendar picker.
- Bold dates indicate saved daily-summary activity; the picker opens even when no past summaries exist.
