# FireVault Build 0.62.0 — Clean Install
...
5. Confirm the build badge shows 0.62.0.
6. Open Settings → Team Sync and confirm records are tracked locally.

Build 0.62.0 prepares local records for future multi-user synchronization. It does not connect to or upload data to OneDrive yet.
