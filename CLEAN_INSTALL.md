# FireVault Build 1.03.12 deployment
...
Before opening the Home Screen app, load `version.json` from the published site and confirm it reports Build 1.03.12. Then open FireVault and use Settings → About FireVault → App Updates → Check for Updates. Do not delete the Home Screen app or clear Safari website data during a normal update.
