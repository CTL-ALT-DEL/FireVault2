# Clean Install Notes — FireVault Build 0.50.64

This ZIP is intended to be used as the new clean baseline for FireVault Build 0.50.64.
...
Build 0.50.64 continues from the stable 0.50.63 baseline and adds layout control toggles.
...
- Adds Settings → Modules toggles for Field Focus, Data Safe Home Card, Site Brief, and Site Activity Timeline.
- Keeps underlying tools available even when their Home/account cards are hidden.
