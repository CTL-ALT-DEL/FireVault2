# Clean Install Notes — FireVault Build 0.50.59

This ZIP is intended to be used as the new clean baseline for FireVault Build 0.50.59.
...
Build 0.50.59 continues from the stable 0.50.58 baseline and adds expandable Site Activity Timeline controls.
...
- Adds Show More / Collapse controls for the Activity Timeline.
- Adds Copy Full for the full filtered timeline.
