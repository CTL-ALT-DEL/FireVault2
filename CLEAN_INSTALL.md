# Clean Install Notes — FireVault Build 0.50.75

This ZIP is intended to be used as the new clean baseline for FireVault Build 0.50.75.
...
- Open Settings → Modules and select a preset. The active preset remains highlighted.
- Visible FireVault wordmarks now use FIRE in red and VAULT in white.
