# Clean Install Notes — FireVault Build 0.50.61

This ZIP is intended to be used as the new clean baseline for FireVault Build 0.50.61.
...
Build 0.50.61 continues from the stable 0.50.60 baseline and adds Field Focus to Home.
...
- Adds Field Focus dashboard for attention sites, open tasks, deficiencies, photos, due-today tasks, overdue tasks, report photos, and route days.
- Adds Copy Field Focus in Data Tools.
