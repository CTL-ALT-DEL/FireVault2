# Clean Install Notes — FireVault Build 0.50.66

This ZIP is intended to be used as the new clean baseline for FireVault Build 0.50.66.
...
Build 0.50.66 continues from the stable 0.50.65 baseline and adds Pinned Sites.
...
- Adds Pinned Sites for high-use accounts.
- Pin or unpin a site from the account screen using the star button.
