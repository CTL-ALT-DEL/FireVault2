# Clean Install Notes — FireVault Build 0.50.67

This ZIP is intended to be used as the new clean baseline for FireVault Build 0.50.67.
...
- Adds Pinned Sites Manager for viewing and managing all pinned accounts.
- Home Pinned Sites now includes an All button.
