...
function home(){
  ...
  html(`<div class="screen">
    ...
    <div class="card grow"><h2>Build 0.40.1</h2><p>Theme selections now affect the actual app layout, buttons, cards, accent color, text size, and iPhone status color.</p><p>Home-screen icons now use the selected #8 Flame Icon logo across the app header, favicon, and PWA home screen.</p></div>
  </div>`);
