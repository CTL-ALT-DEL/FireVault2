...
function home(){
  ...
  html(`<div class="screen">
    ...
    <div class="card grow"><h2>Build 0.40.3</h2><p>Settings now use a compact header, tighter submenu typography, smaller controls, and corrected left alignment across panels.</p><p>The selected #8 Flame Icon remains the official app logo across the header, favicon, and PWA home screen.</p></div>
  </div>`);
