...
const SHELL=["./","./index.html","./manifest.json","./src/app.js?v=0.76.3","./src/storage.js?v=0.76.3","./src/styles.css?v=0.76.3","./assets/favicon.png","./assets/apple-touch-icon.png","./assets/icon-192.png","./assets/icon-512.png"];
