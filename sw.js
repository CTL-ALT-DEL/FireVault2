...
const SHELL=["./","./index.html","./manifest.json","./src/app.js?v=0.75.1","./src/storage.js?v=0.75.1","./src/styles.css?v=0.75.1","./assets/favicon.png","./assets/apple-touch-icon.png","./assets/icon-192.png","./assets/icon-512.png"];
