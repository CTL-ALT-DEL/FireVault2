...
const SHELL=["./","./index.html","./manifest.json","./src/app.js?v=0.73.6","./src/storage.js","./src/styles.css?v=0.73.6","./assets/favicon.png","./assets/apple-touch-icon.png","./assets/icon-192.png","./assets/icon-512.png"];
