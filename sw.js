...
const SHELL=["./","./index.html","./manifest.json","./src/app.js?v=0.79.6","./src/storage.js?v=0.79.6","./src/providers.js?v=0.79.6","./src/open-location-code.js?v=0.79.6","./src/styles.css?v=0.79.6","./assets/favicon.png","./assets/apple-touch-icon.png","./assets/icon-192.png","./assets/icon-512.png"];
