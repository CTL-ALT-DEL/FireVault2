...
const SHELL=["./","./index.html","./manifest.json","./version.json","./src/app.js?v=0.96.0","./src/storage.js?v=0.96.0","./src/providers.js?v=0.96.0","./src/open-location-code.js?v=0.96.0","./src/media-store.js?v=0.96.0","./src/app-profile.js?v=0.96.0","./src/module-registry.js?v=0.96.0","./src/module-bindings.js?v=0.96.0","./src/record-schema.js?v=0.96.0","./src/workflow-schema.js?v=0.96.0","./src/theme-profile.js?v=0.96.0","./src/content-pack-registry.js?v=0.96.0","./src/sync-storage-profile.js?v=0.96.0","./src/styles.css?v=0.96.0","./src/design-system.css?v=0.96.0","./assets/favicon.png","./assets/apple-touch-icon.png","./assets/icon-192.png","./assets/icon-512.png","./assets/firevault-logo-master.png","./assets/overlay-sample-fire-alarm-issue.png"];
