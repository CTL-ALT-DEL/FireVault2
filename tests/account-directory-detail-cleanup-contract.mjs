...
equal(build,"1.03.21","The simplified directory and detail layout must ship in the current build.");
...
const marker="Build 1.03.21 — simplified Account Directory and clearer Account Detail tabs";
