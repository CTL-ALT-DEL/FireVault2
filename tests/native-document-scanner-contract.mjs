...
equal(build,"1.03.30","The native Apple scanner must ship in Build 1.03.30.");
...
match(native,/FireVault-iOS\/1\.03\.30/);

equal((project.match(/CURRENT_PROJECT_VERSION = 31;/g)||[]).length,2,"Both app configurations must use native build 31.");
equal((project.match(/MARKETING_VERSION = 1\.03\.30;/g)||[]).length,2,"Both app configurations must use version 1.03.30.");
