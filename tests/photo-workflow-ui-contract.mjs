...
equal(build,"1.03.30");
ok(index.indexOf("src/styles.css?v=1.03.30")<index.indexOf("src/design-system.css?v=1.03.30"),"The final design system must load after legacy application styles.");
