...
equal(build,"1.03.17");
ok(index.indexOf("src/styles.css?v=1.03.17")<index.indexOf("src/design-system.css?v=1.03.17"),"The final design system must load after legacy application styles.");
