...
equal(build,"1.03.15");
ok(index.indexOf("src/styles.css?v=1.03.15")<index.indexOf("src/design-system.css?v=1.03.15"),"The final design system must load after legacy application styles.");
