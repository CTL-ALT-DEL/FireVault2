import { APP_PROFILE } from "./app-profile.js?v=0.98.0";
import { validateAppForgeProfile, appForgeBlueprintExport } from "./app-forge-blueprint.js?v=0.98.0";
...
export function appForgeRecipeBlueprintExport(id,build="0.98.0"){
