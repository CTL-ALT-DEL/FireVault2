export const MODULE_REGISTRY_VERSION = 6;
...
export const MODULE_REGISTRY = Object.freeze([
  ...
  {id:"core.architectureValidation",name:"Architecture Validation",classification:"core",status:"active",description:"Automated profile, dependency, route, schema, workflow, theme, content, storage, and alternate-profile regression checks.",dependencies:["core.records","core.themeProfile","core.contentPacks","core.syncStorageProfile"],appForgeReady:true,apps:{fireVault:true,travelGuide:true,fishing:true,ghostTowns:true,gardening:true,inspection:true}},
