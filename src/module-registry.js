export const MODULE_REGISTRY_VERSION = 9;
...
export const MODULE_REGISTRY = Object.freeze([
  ...
  {id:"core.appForgeGenerator",name:"AppForge Generator Engine",classification:"core",status:"active",description:"Client-side generation of isolated, installable PWA source packages from validated Product Recipes and Factory Manifests.",dependencies:["core.appForgeFactory"],appForgeReady:true,apps:{fireVault:true,travelGuide:true,fishing:true,ghostTowns:true,gardening:true,inspection:true}},
  ...
  {id:"core.locationNavigator",name:"Exact Location Navigator",classification:"core",status:"active",description:"Saved entrances, parking, equipment points, foreground arrival guidance, access notes, property mapping, and route targets.",dependencies:["core.records","core.nearby"],appForgeReady:true,apps:{fireVault:true,travelGuide:true,fishing:true,ghostTowns:true,gardening:true,inspection:true}},
