import { APP_PROFILE, APP_PROFILE_SCHEMA_VERSION } from "./app-profile.js?v=1.01.4";
import { MODULE_REGISTRY, MODULE_REGISTRY_VERSION, moduleRegistryExport } from "./module-registry.js?v=1.01.4";
import { MODULE_BINDINGS_VERSION, moduleBindingsExport } from "./module-bindings.js?v=1.01.4";
import { RECORD_SCHEMA, RECORD_SCHEMA_VERSION, recordSchemaExport } from "./record-schema.js?v=1.01.4";
import { WORKFLOW_SCHEMA, WORKFLOW_SCHEMA_VERSION, workflowSchemaExport } from "./workflow-schema.js?v=1.01.4";
import { THEME_PROFILE_SCHEMA_VERSION, resolveThemeProfile, themeProfileExport } from "./theme-profile.js?v=1.01.4";
import { CONTENT_PACK_SCHEMA_VERSION, CONTENT_SOURCES, CONTENT_PACKS, contentPackRegistryExport } from "./content-pack-registry.js?v=1.01.4";
import { SYNC_STORAGE_PROFILE_SCHEMA_VERSION, STORAGE_PROVIDERS, resolveSyncStorageProfile, syncStorageProfileExport } from "./sync-storage-profile.js?v=1.01.4";
...
export function appForgeBlueprintExport(appProfile=APP_PROFILE,build="1.01.4"){
  const validation=validateAppForgeProfile(appProfile);
  const theme=resolveThemeProfile(appProfile);
