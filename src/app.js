...
const FIREVAULT_MANUAL_058 = [
  ...
  {id:"settings",title:"Settings Reference",icon:"⚙",status:"Current",summary:"Understand each Settings area and the effect it has on FireVault.",topics:[
    ...
    ["Team Sync","Shows technician identity, device identity, pending record changes, conflict policy, and the planned OneDrive workspace. Build 0.63.1 preserves the sync-ready records but does not upload them."],
  ...
  {id:"release",title:"Release & Manual Status",icon:"ⓘ",status:"Living document",summary:"Understand how this documentation will be maintained through Version 1.0.",topics:[
    ["Manual revision","This manual revision matches FireVault Build 0.63.1 and was last reviewed in July 2026."],
...
function manualHome058(){
  ...
  return `<div class="academyHome058">
    ...
    <section class="academyTileGrid058">
      ...
      ${manualTile058("🆕","What’s New","Review changes included in the current release.","new","red","0.63.1")}
...
function manualSimplePage058(type){
 const pages={
  quick:["🚀","Quick Start Guide","Get FireVault ready for a normal field day.",[["1. Verify the build","Confirm the green build badge shows 0.63.1 before entering production information."],["2. Complete Technician Profile","Enter your name, company, phone, email, and license or employee identification."],["3. Review permissions","Allow location and photo access only when FireVault requests them and the feature is needed."],["4. Create or open a site","Add the customer name, full address, panel details, contacts, access notes, and GPS location."],["5. Document the visit","Record notes, photos, tasks, deficiencies, equipment changes, and a service visit."],["6. Finish and protect the data","Review the report, send or copy the required summary, then export a current backup."]]],
  new:["🆕","What’s New in 0.63.1","Help and Academy reader repair.",[["Readable contextual Help","The blue Help button now opens a continuous reader without a sticky article header covering content."],["Reliable scrolling","Manual chapters, tutorials, field tips, and quick-link Help can scroll completely above the bottom navigation."],["Phone formatting","Long headings, descriptions, metadata, and navigation buttons wrap safely on narrow screens."],["Cleaner articles","Manual topics use clearer spacing, stronger section separation, and improved line height."],["Preserved sync foundation","Shared Vault packages, record metadata, and conflict-safe merging remain unchanged."]]],
...
function settingsPanel(){
  ...
  if(settingsTab==="sync") {
    ...
    return `<div class="settingsStack settingsStack540 syncStack062">
      ${settingsSection540("Multi-user foundation","Team & Sync Status","FireVault is now tracking edits as sync-ready records. OneDrive connection will be added in a later build through Microsoft sign-in and a controlled synchronization service.",`
        ...
        <div class="syncReadiness062"><span class="syncDot062 ${connected?'online':'local'}"></span><div><strong>${connected?'Connected':'Local sync foundation active'}</strong><small>${connected?`Last sync ${esc(data.syncState.lastSuccessfulSync)}`:'No OneDrive account is connected yet. Data remains safely local on this device.'}</small></div></div>
      `,"blue")}
      ...
      `,"slate")}
      ${settingsSection540("Cloud plan","OneDrive workspace","Configure the intended shared workspace now. This build does not upload data or request Microsoft credentials.",`
        <div class="settingsGrid settingsGrid540">
          ${fieldBlock("Storage provider",`<select id="syncProvider"><option value="onedrive" selected>Microsoft OneDrive / SharePoint</option></select>`,`Microsoft Graph integration is planned for the connection build.`)}
...
function showChangelog(){
  const notes = [
    "Build 0.63.1 overhauls contextual Help and the FireVault Academy reader while preserving the multi-user sync foundation.",
