...
function showChangelog(){
  const notes = [
    "Build 0.82.0 polishes FireVault for release with consistent typography, spacing, cards, controls, navigation, forms, focus states, responsive behavior, and cleaner visual hierarchy.",
