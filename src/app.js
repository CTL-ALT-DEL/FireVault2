...
function settings(){
  const tabs=[
    ["tech","Tech","ID"],["reports","Reports","Defaults"],["email","Email","Tags"],["overlay","Photos","Overlay"],
    ["themes","Themes","UI"],["advanced","Advanced","* Services"],["backup","Backup","Data"],["about","About","Build"]
  ];
  const active=tabs.find(t=>t[0]===settingsTab)||tabs[0];
  html(`<div class="screen settingsScreen">
    <div class="settingsMicrobar">
      <div class="settingsCrumb"><img class="settingsMicroLogo" src="assets/icon-192.png?v=${BUILD}" alt="FireVault"><span>Settings</span><b>${active[1]}</b></div>
