...
function showChangelog(){
  const notes = [
    "Build 0.86.0 introduces a simplified dark tile Settings dashboard and renames Accounts navigation to Search.",
