...
export function normalize(data){
  ...
  data.settings.gps = data.settings.gps || {enabled:true, captureSiteGps:true, includeGpsInReports:true, includeAccuracy:true, promptOnNewSite:true, mapProvider:"apple", serviceCallGpsEvents:true};
...
export function ensureSite(s){
  ...
  s.gps = s.gps && typeof s.gps === "object" ? s.gps : null;
