import { stageVaultMedia, stripPersistedMediaForStorage, hydrateVaultMediaFromCache } from "./media-store.js?v=0.95.3";
export const BUILD = "0.95.3";
...
export function createDemoVault(){
  ...
  return normalize({
    ...
    settings:{
      ...
      app:{profileId:"firevault",architectureVersion:1,defaultScreen:"home",distanceUnit:"feet",confirmDeletes:true,autoBackupReminder:true,haptics:true,viewMode:"simple"},
...
export function normalize(data){
  ...
  data.settings.app = data.settings.app || {profileId:"firevault", architectureVersion:1, defaultScreen:"home", distanceUnit:"feet", confirmDeletes:true, autoBackupReminder:true, haptics:true, viewMode:"simple"};
  data.settings.app.profileId = String(data.settings.app.profileId||"firevault");
  data.settings.app.architectureVersion = Math.max(1,Number(data.settings.app.architectureVersion)||1);
