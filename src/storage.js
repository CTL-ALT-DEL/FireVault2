import { stageVaultMedia, stripPersistedMediaForStorage, hydrateVaultMediaFromCache } from "./media-store.js?v=0.94.10";
export const BUILD = "0.94.10";
...
export function createDemoVault(){
  ...
  return normalize({
    ...
    settings:{
      ...
      app:{defaultScreen:"home",distanceUnit:"feet",confirmDeletes:true,autoBackupReminder:true,haptics:true,viewMode:"simple"},
...
export function normalize(data){
  ...
  data.settings.app = data.settings.app || {defaultScreen:"home", distanceUnit:"feet", confirmDeletes:true, autoBackupReminder:true, haptics:true, viewMode:"simple"};
