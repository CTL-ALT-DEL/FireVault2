import { APP_PROFILE } from "./app-profile.js?v=1.01.5";
import { MODULE_REGISTRY } from "./module-registry.js?v=1.01.5";
import { CONTENT_PACKS } from "./content-pack-registry.js?v=1.01.5";
import { STORAGE_PROVIDERS } from "./sync-storage-profile.js?v=1.01.5";
import { validateAppForgeProfile, appForgeBlueprintExport } from "./app-forge-blueprint.js?v=1.01.5";
import { APP_FORGE_RECIPE_SCHEMA_VERSION, appForgeRecipes, appForgeRecipeById } from "./app-forge-recipes.js?v=1.01.5";
...
export function appForgeFactoryManifest(recipeId="firevault",build="1.01.5",overrides={}){
...
export function appForgeFactorySummary(build="1.01.5"){
