...
Shared action surfaces and Quick Photo behavior are now selected by the App Profile. Actions still require their supporting module, keeping module boundaries enforceable while allowing AppForge profiles to tailor the workflow without screen forks.
