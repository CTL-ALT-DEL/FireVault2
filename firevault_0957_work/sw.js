...
const SHELL=["./","./index.html","./manifest.json","./version.json","./src/app.js?v=0.95.7","./src/storage.js?v=0.95.7","./src/providers.js?v=0.95.7","./src/open-location-code.js?v=0.95.7","./src/media-store.js?v=0.95.7","./src/app-profile.js?v=0.95.7","./src/module-registry.js?v=0.95.7","./src/module-bindings.js?v=0.95.7","./src/record-schema.js?v=0.95.7","./src/workflow-schema.js?v=0.95.7","./src/styles.css?v=0.95.7","./src/design-system.css?v=0.95.7","./assets/favicon.png","./assets/apple-touch-icon.png","./assets/icon-192.png","./assets/icon-512.png","./assets/firevault-logo-master.png","./assets/overlay-sample-fire-alarm-issue.png"];
